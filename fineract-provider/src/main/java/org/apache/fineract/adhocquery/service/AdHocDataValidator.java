...
public final class AdHocDataValidator {
    ...
    public void validateForUpdate(final String json) {
        ...
        if (this.fromApiJsonHelper.parameterExists("query", element)) {
            ...
            baseDataValidator.reset().parameter("query").value(query).notBlank().notExceedingLengthOf(1000);
        }
        if (this.fromApiJsonHelper.parameterExists("tableName", element)) {
            ...
            baseDataValidator.reset().parameter("tableName").value(tableName).notBlank().notExceedingLengthOf(1000);
        }
        if (this.fromApiJsonHelper.parameterExists("tableField", element)) {
            ...
            baseDataValidator.reset().parameter("tableField").value(tableField).notBlank().notExceedingLengthOf(1000);
        }
        throwExceptionIfValidationWarningsExist(dataValidationErrors);
    }
