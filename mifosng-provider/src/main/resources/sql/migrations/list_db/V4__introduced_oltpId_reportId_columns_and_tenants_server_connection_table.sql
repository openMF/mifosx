...
create table tenant_server_connections(`id` BIGINT(20) NOT NULL AUTO_INCREMENT,`schema_server` VARCHAR(100) NOT NULL DEFAULT 'localhost',
...
CREATE TABLE tenants(
	...
	`oltp_id` BIGINT(20) NULL DEFAULT NULL,
...
INSERT INTO tenants(`id`,`identifier`,`name`,`timezone_id`,`country_id`,`joined_date`,`created_date`,`lastmodified_date`,`oltp_id`)
SELECT  `id`,`identifier`,`name`,`timezone_id`,`country_id`,`joined_date`,`created_date`,`lastmodified_date`,`id` from temp_tenants ;
