...
public class CollateralReadPlatformServiceImpl implements CollateralReadPlatformService {
    ...
    private static final class CollateralMapper implements RowMapper<CollateralData> {
        ...
        private StringBuilder sqlBuilder = new StringBuilder(
                ...
                .append(" oc.name as currencyName,oc.decimal_places as currencyDecimalPlaces, oc.currency_multiplesof as multiplesofDecimal, oc.display_symbol as currencyDisplaySymbol, oc.internationalized_name_code as currencyNameCode")
        ...
        public CollateralData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            final CurrencyData currencyData = new CurrencyData(currencyCode, currencyName, currencyDecimalPlaces, multiplesofDecimal,
