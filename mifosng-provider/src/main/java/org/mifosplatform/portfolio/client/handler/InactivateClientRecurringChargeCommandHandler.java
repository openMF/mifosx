...
public class InactivateClientRecurringChargeCommandHandler implements NewCommandSourceHandler {

    private final ClientChargeWritePlatformService writePlatformService;

    @Autowired
    public InactivateClientRecurringChargeCommandHandler(final ClientChargeWritePlatformService writePlatformService) {
