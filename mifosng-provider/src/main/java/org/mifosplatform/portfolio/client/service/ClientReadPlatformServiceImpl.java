...
public class ClientReadPlatformServiceImpl implements ClientReadPlatformService {
    ...
    private static final class ClientMembersOfGroupMapper implements RowMapper<ClientData> {
        ...
        public ClientMembersOfGroupMapper() {
            ...
            sqlBuilder.append("c.fullname as fullname, c.display_name as displayName,c.emailaddress as emailAddress,c.code as code, ");
        ...
        public ClientData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            return ClientData.instance(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id,
                    firstname, middlename, lastname, fullname, displayName,fathername, emailAddress,code,externalId, mobileNo, dateOfBirth, gender,marital,religion,dependent,education,activationDate,
    ...
    private static final class ClientAddressMapper implements RowMapper<ClientData>{
    	...
    	public ClientData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum)throws SQLException{
    		...
    		return ClientData.clientAddress(id, accountNo, firstname, middlename, lastname, fullname, displayName,fathername,emailAddress,code, officeId, officeName);
    	}
    ...
    private static final class ClientIdentifierMapper implements RowMapper<ClientData> {
        ...
        public ClientData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            return ClientData.clientIdentifier(id, accountNo, firstname, middlename, lastname, fullname, displayName,fathername, emailAddress,code,officeId, officeName);
        }
    }
