...
public class ClientChargesApiResource {
    ...
    public String retrieveAllClientCharges(
        ...
        if (limit != null && offset != null) {
            final Page<ClientChargeData> clientChargesWithPaginationresults = this.clientChargeReadPlatformService.retrieveClientCharges(
                    clientId, chargeStatus, paid, limit, offset);
            return this.toApiJsonSerializer.serialize(settings, clientChargesWithPaginationresults,
