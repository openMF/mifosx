...
public final class ClientDataValidator {
    ...
    public void validateClose(final JsonCommand command) {
        ...
        if (!StringUtils.isBlank(closureDate.toString())) {
            baseDataValidator.reset().parameter(ClientApiConstants.closureDateParamName).value(closureDate).notLessThanMin(0);
        }
