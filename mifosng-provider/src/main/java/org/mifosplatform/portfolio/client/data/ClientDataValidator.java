...
public final class ClientDataValidator {
    ...
    public void validateClose(final JsonCommand command) {
        ...
        if(!StringUtils.isBlank(closureReasonId.toString())) {
            baseDataValidator.reset().parameter(ClientApiConstants.closureReasonIdParamName).value(closureReasonId).notLessThanMin(0);
        }
