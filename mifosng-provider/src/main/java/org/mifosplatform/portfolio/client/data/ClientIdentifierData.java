...
public class ClientIdentifierData {
    ...
    public static ClientIdentifierData singleItem(final Long id, final Long clientId, final CodeValueData documentType,
            ...
            final String documentKey,final LocalDate validity,final Boolean isLifeTime, final String locale, final String dateFormat, final String description) {
        return new ClientIdentifierData(id, clientId, documentType, proofType,documentKey,validity,isLifeTime,locale,dateFormat, description, null, null);
    }
    ...
    public static ClientIdentifierData template(final Collection<CodeValueData> codeValues, final Collection<CodeValueData> proofValues) {
        return new ClientIdentifierData(null, null, null, null,null, null,null, null, null,null, codeValues, proofValues);
    }
    ...
    public static ClientIdentifierData template(final ClientIdentifierData data, final Collection<CodeValueData> codeValues, final Collection<CodeValueData> proofValues) {
        return new ClientIdentifierData(data.id, data.clientId, data.documentType,data.proofType, data.documentKey,data.validity,data.isLifeTime,data.locale, data.dateFormat ,data.description, codeValues, proofValues);
    }
