...
public class ClientIdentifier extends AbstractAuditableCustom<AppUser, Long> {
    ...
    public static ClientIdentifier fromJson(final Client client, final CodeValue documentType,final CodeValue proofType,final JsonCommand command) {
        ...
        final boolean isLifeTime = command.booleanObjectValueOfParameterNamed("isLifeTime");
        
        final String description = command.stringValueOfParameterNamed("description");
        return new ClientIdentifier(client, documentType,proofType, documentKey,validity,isLifeTime, description);
    }
    ...
    private ClientIdentifier(final Client client, final CodeValue documentType,final CodeValue proofType, final String documentKey,final LocalDate validity,final Boolean isLifeTime, final String description) {
        this.client = client;
    ...
    public Map<String, Object> update(final JsonCommand command) {
        ...
        //Implementation of Update is not done with fields such as isLifeTime Valid
