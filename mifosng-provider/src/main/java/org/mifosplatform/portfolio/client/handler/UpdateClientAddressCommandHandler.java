...
public class UpdateClientAddressCommandHandler implements NewCommandSourceHandler {
	...
	@Autowired
	public UpdateClientAddressCommandHandler(final ClientAddressWritePlatformService clientAddressWritePlatformService) {
	...
	public CommandProcessingResult processCommand(final JsonCommand command){
		...
		return this.clientAddressWritePlatformService.updateClientAddress(command.getClientId(), command.entityId(), command);
	}
