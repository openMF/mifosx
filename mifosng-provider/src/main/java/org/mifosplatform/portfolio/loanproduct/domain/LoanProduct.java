...
public class LoanProduct extends AbstractPersistable<Long> {
    ...
    public static LoanProduct assembleFromJson(final Fund fund, final LoanTransactionProcessingStrategy loanTransactionProcessingStrategy,
        ...
        final Integer multiplesofDecimal = command.integerValueOfParameterNamed("multiplesofDecimal");
        
        final MonetaryCurrency currency = new MonetaryCurrency(currencyCode, digitsAfterDecimal,multiplesofDecimal);
