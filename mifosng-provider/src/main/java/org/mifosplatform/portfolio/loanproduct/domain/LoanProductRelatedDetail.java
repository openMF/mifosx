...
public class LoanProductRelatedDetail implements LoanProductMinimumRepaymentScheduleRelatedDetail {
    ...
    @Column(name = "min_nominal_interest_rate_per_period", scale = 6, precision = 19, nullable = false)
    private BigDecimal minNominalInterestRatePerPeriod;
    
    @Column(name = "max_nominal_interest_rate_per_period", scale = 6, precision = 19, nullable = false)
    ...
    @Column(name = "min_number_of_repayments", nullable = false)
    private Integer minNumberOfRepayments;
    
    @Column(name = "max_number_of_repayments", nullable = false)
    ...
    public BigDecimal getMinNominalInterestRatePerPeriod() {
        return BigDecimal.valueOf(Double.valueOf(this.minNominalInterestRatePerPeriod.stripTrailingZeros().toString()));
    }

    public BigDecimal getMaxNominalInterestRatePerPeriod() {
        return BigDecimal.valueOf(Double.valueOf(this.maxNominalInterestRatePerPeriod.stripTrailingZeros().toString()));
    }
    ...
    public Map<String, Object> updateLoanApplicationAttributes(final JsonCommand command, final AprCalculator aprCalculator) {
        ...
        if (command.isChangeInBigDecimalParameterNamed(minInterestRatePerPeriodParamName, this.minNominalInterestRatePerPeriod)) {
        ...
        if (command.isChangeInBigDecimalParameterNamed(maxInterestRatePerPeriodParamName, this.maxNominalInterestRatePerPeriod)) {
