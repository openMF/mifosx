...
public interface DepositAccountReadPlatformService {
    ...
    DepositAccountData retrieveOne(final DepositAccountType depositAccountType, Long productId);
    ...
    DepositAccountData retrieveTemplate(final DepositAccountType depositAccountType, Long clientId, Long groupId, Long productId, boolean staffInSelectedOfficeOnly);
}
