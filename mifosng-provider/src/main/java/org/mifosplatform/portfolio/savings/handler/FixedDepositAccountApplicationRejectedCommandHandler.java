...
@Service
public class FixedDepositAccountApplicationRejectedCommandHandler extends CommandHandlerWithHooks {
    ...
    public FixedDepositAccountApplicationRejectedCommandHandler(
        ...
        super(CommandHookType.FixedDepositAccountApplicationRejected);
