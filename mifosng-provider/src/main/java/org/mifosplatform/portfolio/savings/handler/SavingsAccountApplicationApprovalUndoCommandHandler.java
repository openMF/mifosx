...
@Service
public class SavingsAccountApplicationApprovalUndoCommandHandler extends CommandHandlerWithHooks {
    ...
    public SavingsAccountApplicationApprovalUndoCommandHandler(final SavingsApplicationProcessWritePlatformService writePlatformService) {
        super(CommandHookType.SavingsAccountApplicationApprovalUndo);
