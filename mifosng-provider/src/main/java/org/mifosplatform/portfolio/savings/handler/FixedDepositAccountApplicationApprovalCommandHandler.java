...
@Service
public class FixedDepositAccountApplicationApprovalCommandHandler extends CommandHandlerWithHooks {
    ...
    public FixedDepositAccountApplicationApprovalCommandHandler(
        ...
        super(CommandHookType.FixedDepositAccountApplicationApproval);
