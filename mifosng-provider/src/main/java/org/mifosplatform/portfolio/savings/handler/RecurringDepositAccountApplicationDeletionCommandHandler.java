...
@Service
public class RecurringDepositAccountApplicationDeletionCommandHandler extends CommandHandlerWithHooks {
    ...
    public RecurringDepositAccountApplicationDeletionCommandHandler(
        ...
        super(CommandHookType.RecurringDepositAccountApplicationDeletion);
