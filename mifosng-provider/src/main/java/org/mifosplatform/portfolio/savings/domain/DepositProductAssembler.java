...
public class DepositProductAssembler {
    ...
    public FixedDepositProduct assembleFixedDepositProduct(final JsonCommand command) {
        ...
        validateFixedDepositProduct(fixedDepositProduct);

        return fixedDepositProduct;
    }

    private void validateFixedDepositProduct(FixedDepositProduct fixedDepositProduct) {
...
//        }
        ...
        RecurringDepositProduct recurringDepositProduct = RecurringDepositProduct
                .createNew(name, shortName, description, currency, interestRate, interestCompoundingPeriodType, interestPostingPeriodType,
        ...
        if (command.parameterExists(preClosurePenalApplicableParamName)) {
            ...
            if (preClosurePenalApplicable) {
                ...
                if (command.parameterExists(preClosurePenalInterestParamName)) {
                    ...
                    preClosurePenalInterestOnTypeId = produPreClosureDetail.preClosurePenalInterestOnType();
                }
            }
        } else {
    ...
    public DepositTermDetail assembleDepositTermDetail(final JsonCommand command) {
        ...
        final Integer depositTermTypeId = command.integerValueOfParameterNamed(depositTermTypeIdParamName);
        final SavingsPeriodFrequencyType depositTermType = (depositTermTypeId == null) ? null : SavingsPeriodFrequencyType
                .fromInt(depositTermTypeId);
        ...
        final DepositTermDetail depositTermDetail = DepositTermDetail.createFrom(minDepositTerm, maxDepositTerm, depositTermType,
    ...
    public DepositTermDetail assembleDepositTermDetail(final JsonCommand command, final DepositTermDetail prodDepositTermDetail) {
        ...
        Integer depositTermTypeId = null;
        ...
        if (command.parameterExists(depositTermTypeIdParamName)) {
            depositTermTypeId = command.integerValueOfParameterNamed(depositTermTypeIdParamName);
        } else {
            depositTermTypeId = prodDepositTermDetail.depositTermType();
        }
