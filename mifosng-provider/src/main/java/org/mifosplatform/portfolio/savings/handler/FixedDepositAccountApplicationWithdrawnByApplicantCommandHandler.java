...
@Service
public class FixedDepositAccountApplicationWithdrawnByApplicantCommandHandler extends CommandHandlerWithHooks {
    ...
    public FixedDepositAccountApplicationWithdrawnByApplicantCommandHandler(
        ...
        super(CommandHookType.FixedDepositAccountApplicationWithdrawnByApplicant);
