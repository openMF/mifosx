...
@Service
public class FixedDepositAccountApplicationModificationCommandHandler extends CommandHandlerWithHooks {
    ...
    public FixedDepositAccountApplicationModificationCommandHandler(
        ...
        super(CommandHookType.FixedDepositAccountApplicationModification);
