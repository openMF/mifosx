...
public class DepositAccountRecurringDetail extends AbstractPersistable<Long> {
    ...
    public static DepositAccountRecurringDetail createNew(DepositRecurringDetail recurringDetail, SavingsAccount account) {

        return new DepositAccountRecurringDetail(recurringDetail, account);
    }

    private DepositAccountRecurringDetail(DepositRecurringDetail recurringDetail, SavingsAccount account) {
