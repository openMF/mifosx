...
@Service
public class UndoTransactionRecurringDepositAccountCommandHandler extends CommandHandlerWithHooks {
    ...
    public UndoTransactionRecurringDepositAccountCommandHandler(final DepositAccountWritePlatformService depositAccountWritePlatformService) {
        super(CommandHookType.UndoTransactionRecurringDepositAccount);
