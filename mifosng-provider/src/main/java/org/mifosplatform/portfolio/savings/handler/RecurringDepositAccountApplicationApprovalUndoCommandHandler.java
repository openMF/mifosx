...
@Service
public class RecurringDepositAccountApplicationApprovalUndoCommandHandler extends CommandHandlerWithHooks {
    ...
    public RecurringDepositAccountApplicationApprovalUndoCommandHandler(
        ...
        super(CommandHookType.RecurringDepositAccountApplicationApprovalUndo);
