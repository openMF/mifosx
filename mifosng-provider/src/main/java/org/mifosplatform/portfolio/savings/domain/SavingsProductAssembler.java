...
public class SavingsProductAssembler {
    ...
    public SavingsProduct assemble(final JsonCommand command) {
        ...
        final Integer multiplesofDecimal = command.integerValueOfParameterNamed(multiplesofDecimalParamName);
        MonetaryCurrency currency = new MonetaryCurrency(currencyCode, digitsAfterDecimal,multiplesofDecimal);
