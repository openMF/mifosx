...
@Service
public class PrematureCloseRecurringDepositAccountCommandHandler extends CommandHandlerWithHooks {
    ...
    public PrematureCloseRecurringDepositAccountCommandHandler(final DepositAccountWritePlatformService depositAccountWritePlatformService) {
        super(CommandHookType.PrematureCloseRecurringDepositAccount);
