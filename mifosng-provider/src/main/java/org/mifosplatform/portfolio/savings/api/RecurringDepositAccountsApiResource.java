...
public class RecurringDepositAccountsApiResource {
    ...
    public String retrieveOne(@PathParam("accountId") final Long accountId,
        ...
        final RecurringDepositAccountData account = (RecurringDepositAccountData) this.depositAccountReadPlatformService.retrieveOneWithChartSlabs(
    ...
    public String handleCommands(@PathParam("accountId") final Long accountId, @QueryParam("command") final String commandParam,
        ...
        if (is(commandParam, "reject")) {
            ...
            final CommandWrapper commandRequest = builder.closeRecurringDepositAccountApplication(accountId).build();
            result = this.commandsSourceWritePlatformService.logCommandSource(commandRequest);
        }
