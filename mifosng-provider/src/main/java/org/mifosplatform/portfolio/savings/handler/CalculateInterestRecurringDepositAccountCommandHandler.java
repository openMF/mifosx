...
@Service
public class CalculateInterestRecurringDepositAccountCommandHandler extends CommandHandlerWithHooks {
    ...
    public CalculateInterestRecurringDepositAccountCommandHandler(final DepositAccountWritePlatformService depositAccountWritePlatformService) {
        super(CommandHookType.CalculateInterestRecurringDepositAccount);
