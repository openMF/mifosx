...
public class DepositAccountAssembler {
    ...
    public SavingsAccount assembleFrom(final JsonCommand command, final AppUser submittedBy, final DepositAccountType depositAccountType) {
        ...
        if (command.parameterExists(chartIdParamName)) {
            ...
            productChart = product.applicableChart();
        }
        ...
        if (depositAccountType.isFixedDeposit()) {
            ...
            account = FixedDepositAccount.createNewApplicationForSubmittal(client, group, product, fieldOfficer, accountNo, externalId,
                    accountType, submittedOnDate, submittedBy, interestRate, interestCompoundingPeriodType, interestPostingPeriodType,
                    interestCalculationType, interestCalculationDaysInYearType, minRequiredOpeningBalance, lockinPeriodFrequencyTypeValue,
                    lockinPeriodFrequencyType, iswithdrawalFeeApplicableForTransfer, charges, accountTermAndPreClosure, accountChart);
            ...
            account = RecurringDepositAccount.createNewApplicationForSubmittal(client, group, product, fieldOfficer, accountNo, externalId,
                    accountType, submittedOnDate, submittedBy, interestRate, interestCompoundingPeriodType, interestPostingPeriodType,
                    interestCalculationType, interestCalculationDaysInYearType, minRequiredOpeningBalance, lockinPeriodFrequencyTypeValue,
                    lockinPeriodFrequencyType, iswithdrawalFeeApplicableForTransfer, charges, accountTermAndPreClosure, accountRecurringDetail, accountChart);
            
            accountTermAndPreClosure.updateAccountReference(account);
            accountRecurringDetail.updateAccountReference(account);
        }        
    ...
    public DepositAccountTermAndPreClosure assembleAccountTermAndPreClosure(final JsonCommand command,
        ...
        return DepositAccountTermAndPreClosure.createNew(updatedProductPreClosure, updatedProductTerm, account, depositAmount, null, depositPeriod, depositPeriodFrequency);
    }
    ...
    public DepositAccountRecurringDetail assembleAccountRecurringDetail(final JsonCommand command,
        ...
        if (command.parameterExists(recurringDepositFrequencyTypeIdParamName)) {
            ...
            recurringDepositFrequencyTypeValue = prodRecurringDetail.recurringDepositFrequencyType();
        }
        ...
        final DepositAccountRecurringDetail depositAccountRecurringDetail = DepositAccountRecurringDetail.createNew(depositRecurringDetail,
                null);
