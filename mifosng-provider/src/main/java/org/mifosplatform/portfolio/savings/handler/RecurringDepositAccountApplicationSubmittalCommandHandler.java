...
@Service
public class RecurringDepositAccountApplicationSubmittalCommandHandler extends CommandHandlerWithHooks {
    ...
    public RecurringDepositAccountApplicationSubmittalCommandHandler(
        ...
        super(CommandHookType.RecurringDepositAccountApplicationSubmittal);
