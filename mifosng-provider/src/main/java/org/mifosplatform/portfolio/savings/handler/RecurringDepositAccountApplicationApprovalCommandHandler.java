...
@Service
public class RecurringDepositAccountApplicationApprovalCommandHandler extends CommandHandlerWithHooks {
    ...
    public RecurringDepositAccountApplicationApprovalCommandHandler(
        ...
        super(CommandHookType.RecurringDepositAccountApplicationApproval);
