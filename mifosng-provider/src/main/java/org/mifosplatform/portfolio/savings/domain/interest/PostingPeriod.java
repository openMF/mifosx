        ...
        case QUATERLY:
             ...
             while (!periodStartDate.isAfter(qPostingPeriodEndDate) && !periodEndDate.isAfter(qPostingPeriodEndDate)) {
                 ...
                 if (postingPeriodInterval.contains(compoundingPeriodInterval)) {
                     ...
                     compoundingPeriod = QuarterlyCompoundingPeriod.create(compoundingPeriodInterval, allEndOfDayBalances, upToInterestCalculationDate);
                     compoundingPeriods.add(compoundingPeriod);
                 }
         ...
         case BI_ANNUAL:
             ...
             while (!periodStartDate.isAfter(bPostingPeriodEndDate) && !periodEndDate.isAfter(bPostingPeriodEndDate)) {
                 ...
                 if (postingPeriodInterval.contains(compoundingPeriodInterval)) {
                     ...
                     compoundingPeriod = BiAnnualCompoundingPeriod.create(compoundingPeriodInterval, allEndOfDayBalances, upToInterestCalculationDate);
                     compoundingPeriods.add(compoundingPeriod);
                 }
         ...
         case ANNUAL:
             ...
             while (!periodStartDate.isAfter(aPostingPeriodEndDate) && !periodEndDate.isAfter(aPostingPeriodEndDate)) {
                 ...
                 if (postingPeriodInterval.contains(compoundingPeriodInterval)) {
                     ...
                     compoundingPeriod = AnnualCompoundingPeriod.create(compoundingPeriodInterval, allEndOfDayBalances, upToInterestCalculationDate);
                     compoundingPeriods.add(compoundingPeriod);
                 }
