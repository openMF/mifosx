...
@Service
public class FixedDepositAccountApplicationApprovalUndoCommandHandler extends CommandHandlerWithHooks {
    ...
    public FixedDepositAccountApplicationApprovalUndoCommandHandler(
        ...
        super(CommandHookType.FixedDepositAccountApplicationApprovalUndo);
