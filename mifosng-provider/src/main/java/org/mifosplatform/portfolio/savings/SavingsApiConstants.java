...
public class SavingsApiConstants {
    ...
    public static final String multiplesofDecimalParamName = "multiplesofDecimal";
    ...
    public static final Set<String> SAVINGS_PRODUCT_REQUEST_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(localeParamName,
            ...
            multiplesofDecimalParamName, nominalAnnualInterestRateParamName, interestCompoundingPeriodTypeParamName,
    ...
    public static final Set<String> SAVINGS_PRODUCT_RESPONSE_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(idParamName,
            nameParamName, descriptionParamName, "currency", digitsAfterDecimalParamName, multiplesofDecimalParamName,
