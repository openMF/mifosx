...
@Service
public class CalculateInterestFixedDepositAccountCommandHandler extends CommandHandlerWithHooks {
    ...
    public CalculateInterestFixedDepositAccountCommandHandler(final DepositAccountWritePlatformService depositAccountWritePlatformService) {
        super(CommandHookType.CalculateInterestFixedDepositAccount);
