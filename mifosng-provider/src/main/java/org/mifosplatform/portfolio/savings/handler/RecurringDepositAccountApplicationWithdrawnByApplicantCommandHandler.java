...
@Service
public class RecurringDepositAccountApplicationWithdrawnByApplicantCommandHandler extends CommandHandlerWithHooks {
    ...
    public RecurringDepositAccountApplicationWithdrawnByApplicantCommandHandler(
        ...
        super(CommandHookType.RecurringDepositAccountApplicationWithdrawnByApplicant);
