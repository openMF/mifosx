...
public class InterestRateChartFields {
    ...
    public boolean isOverlapping(InterestRateChartFields that) {
        ...
        if (this.getEndDateAsLocalDate() == null) {
            if (that.getEndDateAsLocalDate() == null) {
                return true;
            } else if ((this.getFromDateAsLocalDate().isBefore(that.getEndDateAsLocalDate()) || this.getFromDateAsLocalDate().isEqual(
                    that.getEndDateAsLocalDate()))) { return true; }
        } else {
            if (that.getEndDateAsLocalDate() == null) {
                if (that.getFromDateAsLocalDate().isBefore(this.getEndDateAsLocalDate())
                        || that.getFromDateAsLocalDate().isEqual(this.getEndDateAsLocalDate())) { return true; }
            } else {
                if ((this.getFromDateAsLocalDate().isBefore(that.getEndDateAsLocalDate()) || this.getFromDateAsLocalDate().isEqual(
                        that.getEndDateAsLocalDate()))
                        && (that.getFromDateAsLocalDate().isBefore(this.getEndDateAsLocalDate()) || that.getFromDateAsLocalDate().isEqual(
                                this.getEndDateAsLocalDate()))) { return true; }
            }
        }
