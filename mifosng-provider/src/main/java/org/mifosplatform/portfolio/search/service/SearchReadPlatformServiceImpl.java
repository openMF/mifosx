...
public class SearchReadPlatformServiceImpl implements SearchReadPlatformService {
    ...
    @Override
	public Page<AdHocSearchQueryData> retrieveAdHocQueryMatchingDataDetails(
			final AdHocQuerySearchConditions searchConditions, final SearchParameters searchParameters) {
    	this.context.authenticatedUser();
    ...
    private static final class AdHocQuerySearchMapper implements RowMapper<AdHocSearchQueryData> {
        ...
        public String fundMappingSchema(final AdHocQuerySearchConditions searchConditions, final MapSqlParameterSource params) {
        	...
        	sql.append("a.display_name as clientName, a.name as officeName, a.productName, a.fundName, a.loanId, a.disburseAmt, a.disburseOnDate, ")
        ...
        public AdHocSearchQueryData mapRow(ResultSet rs, @SuppressWarnings("unused") int rowNum) throws SQLException {
            ...
            return AdHocSearchQueryData.matchedResult(clientName, officeName, loanProductName, fundName, count, disburseAmount, disburseOnDate,
            		loanOutStanding, percentage, loanId);
        }
