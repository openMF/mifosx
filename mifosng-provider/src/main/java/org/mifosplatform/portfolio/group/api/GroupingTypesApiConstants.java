...
public class GroupingTypesApiConstants {
    ...
    public static final Set<String> GROUP_ROLES_RESPONSE_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(idParamName, roleParamName, 
            groupIdParamName, clientIdParamName, groupRolesParamName));
}