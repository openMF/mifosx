...
public class InvalidPaidInAdvanceAmountException extends AbstractPlatformDomainRuleException {
    ...
    public InvalidPaidInAdvanceAmountException(final String action, final String postFix, final String defaultUserMessage,
            final Object... defaultUserMessageArgs) {
        super("error.msg.loan.amount.is.invalid.or.loan.not.paid.in.action" + action + "." + postFix, defaultUserMessage, defaultUserMessageArgs);
    }
}