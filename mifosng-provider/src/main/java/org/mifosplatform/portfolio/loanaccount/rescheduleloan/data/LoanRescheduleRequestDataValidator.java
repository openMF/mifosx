...
public class LoanRescheduleRequestDataValidator {
    ...
    public void validateForCreateAction(final JsonCommand jsonCommand, final Loan loan) {
        ...
        if(loan.isMultiDisburmentLoan()) {
            dataValidatorBuilder.reset().failWithCodeNoParameterAddedToErrorCode(RescheduleLoansApiConstants.multiDisbursementLoan,
                    "Loan rescheduling is not supported for multidisbursement loans");
        }
        
        if(loan.isInterestRecalculationEnabledForProduct()) {
            dataValidatorBuilder.reset().failWithCodeNoParameterAddedToErrorCode(RescheduleLoansApiConstants.interestRecalculationEnabled,
