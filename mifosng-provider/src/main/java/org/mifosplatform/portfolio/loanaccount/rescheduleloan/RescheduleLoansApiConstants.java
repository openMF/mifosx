...
public class RescheduleLoansApiConstants {
    ...
    public static final String multiDisbursementLoan = "multidisbursementLoan";
    public static final String interestRecalculationEnabled = "interestrecalculationenabled";
