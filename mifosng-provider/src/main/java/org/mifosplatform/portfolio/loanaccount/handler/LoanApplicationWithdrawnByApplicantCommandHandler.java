...
@Service
public class LoanApplicationWithdrawnByApplicantCommandHandler extends CommandHandlerWithHooks {
    ...
    public LoanApplicationWithdrawnByApplicantCommandHandler(final LoanApplicationWritePlatformService writePlatformService) {
        super(CommandHookType.LoanApplicationWithdrawnByApplicant);
