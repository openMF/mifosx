        ...
        if (loanTransaction.isInterestWaiver()) {
            ...
            for (final LoanRepaymentScheduleInstallment installment : installments) {
                if ((installment.isInterestDue(currency)
                        || installment.getFeeChargesCharged(currency).minus(installment.getFeeChargesPaid(currency)).isGreaterThanZero() 
                        || installment.getPenaltyChargesCharged(currency).minus(installment.getPenaltyChargesPaid(currency)).isGreaterThanZero())
