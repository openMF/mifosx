...
public class GroupLoansApiResource {
    ...
    private final Set<String> GROUP_LOAN_DATA_PARAMETERS = new HashSet<String>(Arrays.asList("id", "externalId", "clientId", "groupId",
    ...
    public GroupLoansApiResource(final PlatformSecurityContext context, final LoanReadPlatformService loanReadPlatformService,
            ...
            final StaffReadPlatformService staffReadPlatformService, final DefaultToApiJsonSerializer<LoanAccountData> toApiJsonSerializer,
    ...
    public String retrieveDetailsForNewLoanApplicationStepOne(@QueryParam("groupId") final Long groupId,
        ...
        return this.toApiJsonSerializer.serialize(settings, newLoanAccount, GROUP_LOAN_DATA_PARAMETERS);
    }
