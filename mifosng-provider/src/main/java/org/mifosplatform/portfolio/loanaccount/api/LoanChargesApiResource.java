...
public class LoanChargesApiResource {
    ...
    public String retrieveTemplate(@PathParam("loanId") final Long loanId,@Context final UriInfo uriInfo) {
        ...
        final Collection<ChargeData> chargeOptions = this.chargeReadPlatformService.retrieveLoanApplicableCharges(loanId, feeChargesOnly,new Integer[]{ChargeTimeType.OVERDUE_INSTALLMENT.getValue()});
