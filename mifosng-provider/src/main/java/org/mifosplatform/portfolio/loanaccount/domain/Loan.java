...
public class Loan extends AbstractPersistable<Long> {
	...
	@Column(name = "sync_repayments_with_meeting", nullable = true)
	private Boolean syncRepaymentsWithMeeting;
    ...
    public static Loan newIndividualLoanApplication(final String accountNo, final Client client, final Integer loanType,
        ...
        final Boolean syncRepaymentsWithMeeting = null;
        return new Loan(accountNo, client, group, loanType, fund, officer, loanPurpose, transactionProcessingStrategy, loanProduct,
                loanRepaymentScheduleDetail, status, loanCharges, collateral, syncDisbursementWithMeeting, syncRepaymentsWithMeeting);
    }
    ...
    public static Loan newGroupLoanApplication(final String accountNo, final Group group, final Integer loanType,
            ...
            final LoanTransactionProcessingStrategy transactionProcessingStrategy,
            final LoanProductRelatedDetail loanRepaymentScheduleDetail, final Set<LoanCharge> loanCharges, 
            final Boolean syncDisbursementWithMeeting, final Boolean syncRepaymentsWithMeeting) {
        final LoanStatus status = null;
    ...
    private Loan(final String accountNo, final Client client, final Group group, final Integer loanType, final Fund fund,
            ...
            final Boolean syncRepaymentsWithMeeting) {
        ...
        this.syncRepaymentsWithMeeting = syncRepaymentsWithMeeting;
    }
    ...
    public Map<String, Object> loanApplicationModification(final JsonCommand command, final Set<LoanCharge> possiblyModifedLoanCharges,
        ...
        if (command.isChangeInBooleanParameterNamed(syncRepaymentsParameterName, isSyncRepaymentsWithMeeting())) {
        	final Boolean valueAsInput = command.booleanObjectValueOfParameterNamed(syncRepaymentsParameterName);
        	actualChanges.put(syncRepaymentsParameterName, valueAsInput);
        	this.syncRepaymentsWithMeeting = valueAsInput;
        }
	...
	public boolean isSyncRepaymentsWithMeeting() {
		return this.syncRepaymentsWithMeeting ==  null ? false : this.syncRepaymentsWithMeeting;
	}
