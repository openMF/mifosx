...
@Entity
@Table(name = "m_fund_mapping_history", 
uniqueConstraints = { @UniqueConstraint(columnNames = { "loan_id", "fund_type_cv_id" }, name = "fund_loan_id_fundtype")})
public class FundMappingHistory extends AbstractPersistable<Long>{
    ...
    private FundMappingHistory(final Loan loan, final CodeValue fundTypeCodeValue,
