...
public class UserDetailsApiResource {
    ...
    public String fetchAuthenticatedUserData(@QueryParam("access_token") final String accessToken) {
        ...
        if (authentication.isAuthenticated()) {
            ...
            AuthenticatedUserData authenticatedUserData = new AuthenticatedUserData(principal.getUsername(), permissions);
            ...
            if (this.springSecurityPlatformSecurityContext.doesPasswordHasToBeRenewed(principal)) {
                authenticatedUserData = new AuthenticatedUserData(principal.getUsername(), principal.getId(), accessToken);
            } else {

                authenticatedUserData = new AuthenticatedUserData(principal.getUsername(), officeId, officeName, staffId, staffDisplayName,
