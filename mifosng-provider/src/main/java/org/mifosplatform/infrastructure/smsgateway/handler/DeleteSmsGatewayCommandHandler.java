...
@Service
public class DeleteSmsGatewayCommandHandler implements NewCommandSourceHandler {

    private final SmsGatewayWritePlatformService writePlatformService;

    @Autowired
    public DeleteSmsGatewayCommandHandler(final SmsGatewayWritePlatformService writePlatformService) {
