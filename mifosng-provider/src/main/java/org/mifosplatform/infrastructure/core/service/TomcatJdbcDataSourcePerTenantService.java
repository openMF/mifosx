...
public class TomcatJdbcDataSourcePerTenantService implements RoutingDataSourceService {
    ...
    public DataSource retrieveDataSource() {
        ...
        if (ThreadLocalContextUtil.getTenant() != null) {
            final MifosPlatformTenantConnection tenantConnection = ThreadLocalContextUtil.isReportRequest() != null
                    && ThreadLocalContextUtil.isReportRequest() ? ThreadLocalContextUtil.getTenant().getReportsConnection()
                    : ThreadLocalContextUtil.getTenant().getOltpConnection();
