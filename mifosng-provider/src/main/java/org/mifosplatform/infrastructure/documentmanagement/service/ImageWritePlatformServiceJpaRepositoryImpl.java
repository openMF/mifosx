...
public class ImageWritePlatformServiceJpaRepositoryImpl implements ImageWritePlatformService {
    ...
    @Transactional
    @Override
    public CommandProcessingResult saveOrUpdateImage(String clientName, final Long clientId, final String imageName,
    ...
    private void validateImageType(final String clientName) {
        if (!checkValidEntityType(clientName)) { throw new InvalidImageTypeException(clientName); }
    }
