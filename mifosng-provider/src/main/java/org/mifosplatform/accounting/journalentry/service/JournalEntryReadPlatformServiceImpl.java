...
public class JournalEntryReadPlatformServiceImpl implements JournalEntryReadPlatformService {
    ...
    public JournalEntryReadPlatformServiceImpl(final RoutingDataSource dataSource,
            ...
            final OfficeReadPlatformService officeReadPlatformService, FinancialActivityAccountRepositoryWrapper financialActivityAccountRepositoryWrapper) {
    ...
    public OfficeOpeningBalancesData retrieveOfficeOpeningBalances(final Long officeId) {
    	...
    	final FinancialActivityAccount financialActivityAccountId = this.financialActivityAccountRepositoryWrapper.findByFinancialActivityTypeWithNotFoundDetection(500);
