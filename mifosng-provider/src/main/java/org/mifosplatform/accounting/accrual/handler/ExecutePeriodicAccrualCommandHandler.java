 ...
 */
package org.mifosplatform.accounting.accrual.handler;
...
@Service
public class ExecutePeriodicAccrualCommandHandler extends CommandHandlerWithHooks {
    ...
    public ExecutePeriodicAccrualCommandHandler(final AccrualAccountingWritePlatformService writePlatformService) {
        super(CommandHookType.ExecutePeriodicAccrual);
