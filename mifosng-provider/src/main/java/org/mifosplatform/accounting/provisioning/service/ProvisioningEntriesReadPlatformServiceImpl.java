...
public class ProvisioningEntriesReadPlatformServiceImpl implements ProvisioningEntriesReadPlatformService {
    ...
    public ProvisioningEntryData retrieveProvisioningEntryData(Long entryId) {
        LoanProductProvisioningEntryMapper1 mapper = new LoanProductProvisioningEntryMapper1();
    ...
    private static final class LoanProductProvisioningEntryMapper1 implements RowMapper<LoanProductProvisioningEntryData> {
