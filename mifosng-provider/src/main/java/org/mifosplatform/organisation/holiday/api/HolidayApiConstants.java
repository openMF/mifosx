...
public class HolidayApiConstants {
    ...
    public static final String alternativeWorkingDate = "alternativeWorkingDate";
    ...
    public static final Set<String> HOLIDAY_CREATE_REQUEST_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(localeParamName,
            dateFormatParamName, name, fromDate, toDate, description, offices, alternativeWorkingDate));
}
