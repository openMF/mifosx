...
public class CurrencyData {
    ...
    public CurrencyData(final String code, final String name, final int decimalPlaces,final int multiplesofDecimal, final String displaySymbol, final String nameCode) {
        this.code = code;
        this.name = name;
    ...
    public Integer multiplesofDecimal() {
