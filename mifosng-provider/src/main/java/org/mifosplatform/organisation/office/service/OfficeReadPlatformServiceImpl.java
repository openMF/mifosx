...
public class OfficeReadPlatformServiceImpl implements OfficeReadPlatformService {
    ...
    @Override
    @Cacheable(value = "offices", key = "T(org.mifosplatform.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getName().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy())")
    ...
    @Override
    @Cacheable(value = "office_template", key = "T(org.mifosplatform.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getName().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy())")
