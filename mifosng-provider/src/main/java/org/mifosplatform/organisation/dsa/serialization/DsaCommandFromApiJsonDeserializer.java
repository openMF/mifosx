 ...
 */
package org.mifosplatform.organisation.dsa.serialization;
...
@Component
public class DsaCommandFromApiJsonDeserializer {
	...
	private final Set<String> supportedParameters = new HashSet<>(Arrays.asList("firstname", "lastname", "officeId","mobileNo", "isActive"));
	
	private FromJsonHelper fromApiJsonHelper;
	
	@Autowired
	public DsaCommandFromApiJsonDeserializer(final FromJsonHelper fromJsonHelper){
	...
	public void validateForCreate(final String json){
	    ...
	    final DataValidatorBuilder baseDataValidator = new DataValidatorBuilder(dataValidationErrors).resource("dsa");
