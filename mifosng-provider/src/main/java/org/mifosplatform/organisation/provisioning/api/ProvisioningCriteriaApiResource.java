...
public class ProvisioningCriteriaApiResource {
    ...
    private final Set<String> PROVISIONING_CRITERIA_TEMPLATE_PARAMETER = new HashSet<>(Arrays.asList("provisioninCriteria", "loanProducts",
            "glAccounts"));

    private final Set<String> PROVISIONING_CRITERIA_PARAMETERS = new HashSet<>(Arrays.asList("criteriaName", "loanProducts",
            "definitions"));
    
    private final Set<String> ALL_PROVISIONING_CRITERIA_PARAMETERS = new HashSet<>(Arrays.asList("criteriaId", "criterianame",
            "createdby"));
    ...
    public String retrieveTemplate(@Context final UriInfo uriInfo) {
        ...
        return this.toApiJsonSerializer.serialize(settings, data, this.PROVISIONING_CRITERIA_TEMPLATE_PARAMETER);
    }
    ...
    public String retrieveProvisioningCriteria(@PathParam("criteriaId") final Long criteriaId, @Context final UriInfo uriInfo) {
        ...
        return this.toApiJsonSerializer.serialize(settings, criteria, this.PROVISIONING_CRITERIA_PARAMETERS); 
    }
    ...
    public String retrieveAllProvisioningCriterias(@Context final UriInfo uriInfo) {
        ...
        final ApiRequestJsonSerializationSettings settings = this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
        return this.toApiJsonSerializer.serialize(settings, data, this.ALL_PROVISIONING_CRITERIA_PARAMETERS); 
    }
