...
public class ServerWithMariaDB4jApplication {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!Desktop.isDesktopSupported()) {
            ...
            Resource distResource = ctx.getResource("file:" + System.getProperty("user.dir") + System.getProperty("file.separator")
                    + "apps" + System.getProperty("file.separator") + "community-app" + System.getProperty("file.separator") + "dist"
                    + System.getProperty("file.separator") + "community-app" + System.getProperty("file.separator") + "index.html");
            URI distURI = URI
                    .create("https://localhost:8443/mifosng-provider"
