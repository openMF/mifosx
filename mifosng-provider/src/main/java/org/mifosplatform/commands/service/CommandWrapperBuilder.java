...
public class CommandWrapperBuilder {
    ...
    public CommandWrapper build() {
        return new CommandWrapper(this.officeId, this.groupId, this.clientId, this.loanId, this.savingsId, this.actionName,
                ...
                this.json, this.transactionId, this.productId, this.templateId, this.interestRatechartId, this.depositAccountType);
    }
    ...
    public CommandWrapperBuilder closeFixedDepositAccountApplication(final Long accountId) {
        this.actionName = "CLOSE";
        this.entityName = "FIXEDDEPOSITACCOUNT";
        this.entityId = accountId;
        this.savingsId = accountId;
    ...
    public CommandWrapperBuilder closeRecurringDepositAccountApplication(final Long accountId) {
        this.actionName = "CLOSE";
        this.entityName = "RECURRINGDEPOSITACCOUNT";
        this.entityId = accountId;
        this.savingsId = accountId;
