...
public class CommandWrapperBuilder {
    ...
    public CommandWrapperBuilder createDBDatatable(final String json) {
    	...
    	this.entityId = null;
    	this.href = "/datatables/db/";
    	this.json = json;
    	return this;
    }

    public CommandWrapperBuilder updateDBDatatable(final String json) {
    	this.actionName = "UPDATE";
    	this.entityName = "DATATABLE";
    	this.entityId = null;
    	this.href = "/datatables/db/";
    ...
    public CommandWrapperBuilder deleteDBDatatable(final String json) {
    	this.actionName = "DELETE";
    	this.entityName = "DATATABLE";
    	this.entityId = null;
    	this.href = "/datatables/db/";
