...
public class DepositAccountReadPlatformServiceImpl implements DepositAccountReadPlatformService {
	...
	private static final class DepositAccountMapper implements RowMapper<DepositAccountData> {
		...
		public String schema() {
			return "da.id as id, da.external_id as externalId, da.client_id as clientId, da.product_id as productId, da.status_enum as statusEnum, " 
		...
		public DepositAccountData mapRow(ResultSet rs, int rowNum)
			...
			Integer statusEnumValue = JdbcSupport.getInteger(rs, "statusEnum");
			EnumOptionData statusEnum = SavingsDepositEnumerations.depositStatusEnumType(statusEnumValue);
