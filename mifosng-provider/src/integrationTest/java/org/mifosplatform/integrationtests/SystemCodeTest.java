...
public class SystemCodeTest {
    ...
    @Test
    public void testCreateCodeAndCodeValueWithDepenedenyColumn(){
        ...
        final String codeValue1 = Utils.randomNameGenerator("India", 5);
        final String codeValue2 = Utils.randomNameGenerator("USA", 5);
        ...
        final String codeValue3 = Utils.randomNameGenerator("Kerala", 5);
        final String codeValue4 = Utils.randomNameGenerator("LV", 5);
        ...
        final HashMap codeValueChanges = (HashMap) CodeHelper.updateCodeValue(this.requestSpec, this.responseSpec, createResponseId,
        		createCodeValueResponseId3, codeValue3 + "CHANGE", codeDescription3 + "CHANGE", 4, createCodeValueResponseId1, "changes");

        assertEquals("Verify changed code value name", codeValueChanges.get("name"), codeValue3 + "CHANGE");

        assertEquals("Verify changed code value description", codeValueChanges.get("description"), codeDescription3 + "CHANGE");
        
        // delete code value
        Integer deletedCodeValueResponseId1 = (Integer) CodeHelper.deleteCodeValueById(this.requestSpec, this.generalResponseSpec,
        		createResponseId, createCodeValueResponseId3, CodeHelper.SUBRESPONSE_ID_ATTRIBUTE_NAME);

        // Verify code value deleted

        final ArrayList<HashMap> deletedCodeValueAttributes1 = (ArrayList<HashMap>) CodeHelper.getCodeValueById(this.requestSpec,
                this.generalResponseSpec, createResponseId, deletedCodeValueResponseId1, CommonConstants.RESPONSE_ERROR);
