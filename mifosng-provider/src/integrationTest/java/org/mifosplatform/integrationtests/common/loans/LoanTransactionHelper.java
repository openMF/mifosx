...
public class LoanTransactionHelper {
    ...
    public HashMap undoLastDisbursal(final Integer loanID) {
        ...
        System.out.println("IN DISBURSE LOAN URL " + url);
        return performLoanTransaction(createLoanOperationURL(UNDO_LAST_DISBURSE_LOAN_COMMAND, loanID), undoLastDisburseJson);
    }
