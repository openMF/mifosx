...
public class ClientChargesTest {
    ...
    public void clientChargeTest() {
        ...
        // associate the loan charge to a client
        ...
        // associates a clientCharge to a client
        ...
        // paying client charge for 10 USD
        ...
        */
        ...
        // check weather the client charge transaction is reversed or not
        ...
        // pay client charge before client activation date and ensured its afailure test case
    ...
    /**
     * Check whether the amount is updated properly or not after paying the
     * client charge
     * 
