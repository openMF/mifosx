...
public class LoanApplicationApprovalTest {
	...
	private void trancheLoansApprovalValidation(Integer clientID,
		...
		final String approvalAmount4 = "400";
		...
		/* Sum of tranches and approved amount is not same */
		...
		assertEquals(
				"validation.msg.loan.principal.sum.of.multi.disburse.amounts.must.equal.with.total.principal",
				error.get(0).get(CommonConstants.RESPONSE_ERROR_MESSAGE_CODE));
