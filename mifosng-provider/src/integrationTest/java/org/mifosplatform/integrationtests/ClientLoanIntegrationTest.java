...
public class ClientLoanIntegrationTest {
    ...
    private JsonObject createLoanProductConfigurationDetailAsTrue(JsonObject loanProductConfigurationAsTrue) {
    	loanProductConfigurationAsTrue.addProperty("amortizationType", true);
    	loanProductConfigurationAsTrue.addProperty("interestType", true);
    	loanProductConfigurationAsTrue.addProperty("transactionProcessingStrategyId", true);
    	loanProductConfigurationAsTrue.addProperty("interestCalculationPeriodType", true);
    	loanProductConfigurationAsTrue.addProperty("inArrearsTolerance", true);
    	...
    	loanProductConfigurationAsTrue.addProperty("graceOnArrearsAgeing", true);
    ...
    private JsonObject createLoanProductConfigurationDetailAsFalse(JsonObject loanProductConfigurationAsFalse) {
    	loanProductConfigurationAsFalse.addProperty("amortizationType", false);
    	loanProductConfigurationAsFalse.addProperty("interestType", false);
    	loanProductConfigurationAsFalse.addProperty("transactionProcessingStrategyId", false);
    	loanProductConfigurationAsFalse.addProperty("interestCalculationPeriodType", false);
    	loanProductConfigurationAsFalse.addProperty("inArrearsTolerance", false);
    	...
    	loanProductConfigurationAsFalse.addProperty("graceOnArrearsAgeing", false);
